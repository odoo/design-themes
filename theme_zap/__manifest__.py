{
    'name': 'Zap Theme',
    'description': 'Pitch-forward with bold geometric shape motifs. Best for digital marketing agencies, copywriting services, media companies, and event-driven corporate sites. Signature: discovery exploration block, striped sections, charted KPIs, and a CTA card. Avoid for reserved, understated corporate tones; this is bold and pitch-forward. Mood: confident, corporate, dynamic, professional.',
