{
    'name': 'Orchid Theme',
    'description': 'Sales-led header above a kickoff hero opens onto key visuals, a process-steps narrative, a freegrid showcase, an image-text-overlap layout, and a basic team block before an image wall, accented by a varied vocabulary of connection, organic blob, and bold geometric motifs. Process-and-image driven / suited for florists, garden centers, beauty boutiques, and nature-led retail',
    ...
    'theme_customizations': {
        'website_sale.s_dynamic_snippet_category_list': {
            ...
            'background': {
                'color': 'o_cc2',
                'shape': {
                    'data-oe-shape-data': '{"shape":"html_builder/Connections/01", "colors":{"c5":"o-color-3"}, "flip":["x"]}',
                    'element': """<div class="o_we_shape o_html_builder_Connections_01" style="background-image: url('/html_editor/shape/html_builder/Connections/01.svg?c5=o-color-3&amp;flip=x');""",
                },
            },
            'add_classes': [
                'pt104', 'pb152',
