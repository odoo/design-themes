{
    ...
    'images_preview_theme': {
        ...
        'website.s_image_text_default_image': '/theme_orchid/static/src/img/snippets/s_carousel_2.webp',
        'website.s_text_image_default_image': '/theme_orchid/static/src/img/snippets/s_media_list_3.webp',
        'website.s_three_columns_default_image_1': '/theme_orchid/static/src/img/snippets/library_image_11.webp',
        'website.s_three_columns_default_image_2': '/theme_orchid/static/src/img/snippets/library_image_13.webp',
        'website.s_three_columns_default_image_3': '/theme_orchid/static/src/img/snippets/library_image_07.webp',
    },
