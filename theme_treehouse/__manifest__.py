{
    ...
    'images_preview_theme': {
        'website.s_cover_default_image': '/theme_treehouse/static/src/img/content/cover.webp',
        'website.s_text_image_default_image': '/theme_treehouse/static/src/img/content/text_image.webp',
        'website.s_parallax_default_image': '/website/static/src/img/snippets_demo/s_parallax.webp',
        'website.s_three_columns_default_image_1': '/theme_treehouse/static/src/img/content/three_columns_01.webp',
        'website.s_three_columns_default_image_2': '/theme_treehouse/static/src/img/content/three_columns_02.webp',
        'website.s_three_columns_default_image_3': '/theme_treehouse/static/src/img/content/three_columns_03.webp',
    },
