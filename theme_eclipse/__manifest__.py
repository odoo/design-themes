{
    'name': 'Eclipse Theme',
    'description': 'A full-height discovery hero with large call-to-action buttons over a blurry gradient shape opens onto a client logo strip, a two-row feature grid with bordered icons, a text block paired with a doughnut chart metric, a compact quotes carousel, a line chart set against a second blurry shape, key visuals and a mobile app call-to-action, closing on a scrolling announcement ribbon backed by a third blurry shape — with dark near-black palettes, off-white type and thin rules separating every section. Product-led and metric-driven / suited for SaaS products, startups, mobile apps, and technology companies',
    ...
    'configurator_snippets': {
        'homepage': ['s_discovery', 's_references', 's_hr', 's_features', 's_text_chart', 's_quotes_carousel_compact', 's_chart_text', 's_hr', 's_key_images', 's_hr', 's_cta_mobile', 's_announcement_scroll'],
    },
