(function(){
  ...
  website.snippet.animationRegistry.s_showcase_slider = website.snippet.Animation.extend({
    ...
    bindEvents: function(container, sliderPagination){
      ...
      container.find('.s-ss-slider').bind('click.s-ss', function(event){
      ...
      container.find('.s-ss-close').bind('click.s-ss', function(e){
        container.removeClass('active');
      });

      container.find('.s-ss-next').bind('click.s-ss', function(e){
        self.nextSlide(container, sliderPagination);
      });

      container.find('.s-ss-prev').bind('click.s-ss', function(e){
        self.prevSlide(container, sliderPagination);
      });

      sliderPagination.bind('click.s-ss', function(){
