(function(){
  ...
  website.snippet.animationRegistry.s_media_block.include({
    ...
    youtube_video:function(video_id){
      ...
      var $el = $('<div id="'+ timeStamp2 +'" class="player" data-property="{videoURL:\'' + video_id + '\',containment:\'#s_media_block_' + timeStamp +  '\',startAt:'+ $yt_startAt +',stopAt:'+ $yt_stopAt +',mute:'+ $yt_muted +',stopMovieOnBlur:false,vol:'+ $yt_vol +',autoPlay:true,showYTLogo:false,loop:'+ $yt_loop +',opacity:'+ $yt_opacity +'}"></div>/');
