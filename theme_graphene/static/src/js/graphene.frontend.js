odoo.define('theme_graphene.frontend', function (require) {
    ...
    base.ready().then(function () {
        ...
        if ($graph_header.hasClass("top_menu_affix")) {
            ...
            $graph_header_clone = $graph_header.clone().insertAfter($graph_header).attr("id","graph_header_affix").addClass("affix");
    ...
    // Graphene Theme
    sAnimation.registry.graph_init = sAnimation.Class.extend({
        selector : "body",
